...
toSeconds = function(file){
  ...
  colnames(sell_output) = c('time','sell_open','sell_close','sell_low','sell_high','sell_volume','sell_weighted_avg')
  ...
  write.csv(result, file = "ticker_1.csv",row.names=FALSE, col.names=columns) # change output file name here
}
```

```{r}
toSeconds("Ticker1.csv") # change input file name here
```